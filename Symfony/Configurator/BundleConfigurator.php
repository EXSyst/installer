    ...
    private function getConfigFile(Project $project)
    {
        if (null === $this->configFile) {
            ...
            if (isset($extra['symfony-app-dir'])) {
                $default = $project->getRootPackagePath().'/'.$extra['symfony-app-dir'].'/config/config_generated.yml';
            } else {
                $default = $project->getRootPackagePath().'/app/config/config_generated.yml';
            }
            ...
            $this->configFile = $io->ask(sprintf('<info>In which file do you want to save your config?</info> [<comment>%s</comment>]:', $default), $default);
        }
